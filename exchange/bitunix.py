...
class BitunixScraper:
    def __init__(self, analyzer: DeepSeekAnalyzer):
        self.base_url = "https://www.bitunix.com"
        self.browser = None
        self.context = None
        self.page = None
        ...
        self.headers = {
            ...
            'pragma': 'no-cache',
            'priority': 'u=0, i',
            'referer': 'https://support.bitunix.com/hc/en-us',
    ...
    async def run_scraping(self):
        ...
        try:
            ...
            for i, article in enumerate(announcements):
                ...
                text_file_name = f'announcements_text/bitunix_{article_id}.txt'
                json_file_name = f'announcements_json/bitunix_{article_id}.json'
...
async def main():
    """主函数，创建爬虫实例并运行"""
    analyzer = DeepSeekAnalyzer(api_key="sk-790c031d07224ee9a905c970cefffcba")
    scraper = BitunixScraper(analyzer)
