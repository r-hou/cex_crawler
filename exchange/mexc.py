...
class MexcScraper:
    ...
    async def get_announcement_detail(self, article_id):
        ...
        try:
            ...
            json_data = self.get_json_from_html(content)
            text_content = json_data['data']['title'] + "\n" + self.extract_text_from_html(json_data['data']['body'])
    ...
    async def run_scraping(self):
        ...
        try:
            ...
            for i, article in enumerate(announcements):
                ...
                text_file_name = f'announcements_text/mexc_{article_id}.txt'
                json_file_name = f'announcements_json/mexc_{article_id}.json'
